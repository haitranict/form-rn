...
export function SFormResult({
  ...
  useEffect(() => {
    ...
    apiGetFormById(apiConfig, queryKey, shopId || 0).then(result => {
  ...
  // ============================================================
  const normalizeUploadUrl = useCallback(url => {
  ...
  // ============================================================
  const handlePickImageFromGallery = useCallback(question => {
  ...
  const handleCaptureImageFromCamera = useCallback(question => {
  ...
  // ============================================================
  const handleRecordAudio = useCallback(question => {
    if (onRecordAudio) {
  ...
  const handlePickAudioFromFiles = useCallback(question => {
  ...
  if (showIntro && mode === 'fill') {
    return /*#__PURE__*/React.createElement(FormIntro, {
  ...
  }, startTime && mode === 'fill' && /*#__PURE__*/React.createElement(View, {
    style: styles.timerContainer
  }, /*#__PURE__*/React.createElement(FormTimer, {
    startTime: startTime
  })), displayMode === 'all' && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(FormBanner, {
    banner: state.formData.banner
