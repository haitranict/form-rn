...
export function AnswerGrid({
  ...
  const renderTableMode = () => /*#__PURE__*/React.createElement(ScrollView, {
    horizontal: true,
  ...
  const renderGroupByRow = () => /*#__PURE__*/React.createElement(ScrollView, null, rows.map(row => /*#__PURE__*/React.createElement(View, {
    key: row.rowId,
  ...
  }, col.colName), /*#__PURE__*/React.createElement(View, {
    style: styles.groupItemValue
  }, renderCell(row.rowId, col.colId)))))));

  // Render mode: Group by Column
  const renderGroupByColumn = () => /*#__PURE__*/React.createElement(ScrollView, null, cols.map(col => /*#__PURE__*/React.createElement(View, {
    key: col.colId,
    style: styles.groupCard
  }, /*#__PURE__*/React.createElement(Text, {
    style: styles.groupTitle
    ...
    style: styles.groupItemLabel
  }, row.rowName), /*#__PURE__*/React.createElement(View, {
    style: styles.groupItemValue
  }, renderCell(row.rowId, col.colId)))))));
  ...
  }, "\uD83D\uDCCA B\u1EA3ng")), /*#__PURE__*/React.createElement(TouchableOpacity, {
  ...
  }, "\u27A1\uFE0F Theo d\xF2ng")), /*#__PURE__*/React.createElement(TouchableOpacity, {
  ...
  }, "\u2B07\uFE0F Theo c\u1ED9t"))), /*#__PURE__*/React.createElement(View, {
