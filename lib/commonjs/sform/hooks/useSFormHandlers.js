...
exports.useSFormHandlers = useSFormHandlers;
...
function useSFormHandlers({
   ...
   */
  const handleOnChange = (0, _react.useCallback)((question, value, answerItem) => {
    if (!formData) return;
    try {
