...
function AnswerImage({
  ...
  const handlePick = async () => {
    ...
    _reactNative.Alert.alert('Image Picker', 'Tích hợp react-native-image-picker ở đây');
  };
  const handleClear = () => {
  ...
  }, "Ch\u1ECDn \u1EA3nh")), images.length > 0 && /*#__PURE__*/_react.default.createElement(_reactNative.TouchableOpacity, {
