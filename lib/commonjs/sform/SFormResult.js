...
function SFormResult({
  ...
  const handleSubmit = (0, _react.useCallback)(async () => {
    ...
    try {
      const response = await (0, _useSFormApi.apiInsertResult)(apiConfig, payload);
  ...
  }, [apiConfig, onSubmitSuccess, setIsSubmitting, setSended, showError, showSuccess, state.formData, validate]);
