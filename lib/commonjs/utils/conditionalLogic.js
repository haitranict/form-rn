 ...
 */
function evaluateConditional(conditional, allValues) {
 ...
 */
function isFieldVisible(conditional, allValues) {
 ...
 */
function isFieldRequired(conditional, baseRequired, allValues) {
 ...
 */
function isFieldDisabled(conditional, baseDisabled, allValues) {
